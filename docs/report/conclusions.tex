...
\begin{enumerate}
    ...
    \begin{itemize}
        \item With the architecture of \cite{bora2017}, 50 measurements are enough to reach the accuracy the DCT baseline requires 400 measurements to obtain, a saving of a factor 8, and it is more accurate than that baseline on 8 of the 10 individual test images at that budget. The authors report a saving between 5 and 10, so our reproduction falls inside the interval they publish.
    ...
    \begin{itemize}
        ...
        \item Averaged over the budgets from 300 upwards, that floor ranges from 0.0065 for the best model to 0.0233 for the worst, a factor 3.6 between priors, so the choice of generator matters far more than any refinement of the recovery algorithm in this regime.
    \end{itemize}

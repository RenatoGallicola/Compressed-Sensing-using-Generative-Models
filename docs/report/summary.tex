...
\begin{enumerate}
    \item \textbf{Performance with few measurements:} the generative priors are far more accurate than either LASSO baseline when measurements are scarce. The exception is the DCGAN with latent dimension 30, which the DCT baseline overtakes from three hundred measurements onwards. Every VAE prior reaches with 75 measurements the accuracy either baseline obtains with 400, a saving of a factor 5.3, within the range of 5 to 10 the authors report.

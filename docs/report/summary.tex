...
\begin{enumerate}
    ...
    \end{itemize}
\end{enumerate}
For both models, we used a random Gaussian matrix for initial measurements. The compression levels varied from 20 to 770 measurements per image, allowing us to observe the reconstruction quality across different levels of compression.

...
\begin{enumerate}
    \item \textbf{Performance with few measurements:} every generative prior is far more accurate than LASSO when measurements are scarce. The architecture of the reference paper reaches with 75 measurements the accuracy LASSO obtains with 400, a saving of a factor 5.3, within the range of 5 to 10 the authors report.

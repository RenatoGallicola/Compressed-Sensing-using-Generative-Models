...
\begin{enumerate}
    \item \textbf{Performance with few measurements:} both models are far more accurate than LASSO when measurements are scarce. The VAE with a latent dimension of 30 obtains with 75 measurements the accuracy that LASSO reaches with 400, and with 25 measurements its error is 4.2 times lower than the LASSO one.
    \item \textbf{Saturation:} the accuracy of both models stops improving after roughly 200 measurements, because the reconstruction is constrained to the range of the generator. From 500 measurements onwards LASSO becomes the most accurate method.
    \item \textbf{Comparison between the two models:} the VAE with a latent dimension of 30 is the most accurate of the five methods at seven of the ten budgets tested, and its recovery is about 38 times faster than the DCGAN one.
\end{enumerate}

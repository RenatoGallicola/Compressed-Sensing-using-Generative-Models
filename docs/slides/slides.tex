...
% Every figure the deck uses has a copy in assets/, so this folder is all that
% has to be uploaded to build the talk. A test checks each copy against the
% notebook or the script that produced it.
\graphicspath{{assets/}}
